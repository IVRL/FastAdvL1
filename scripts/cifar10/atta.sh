...
python run/train_atta_cifar.py \
    --dataset cifar10 \
    --attack name=pgd,order=1,threshold=12,iter_num=1,step_size=${st},k=${k} \
    --test_attack name=apgd,order=1,threshold=12,iter_num=20 \
...
python run/eval_autoattack.py \
    ...
    --attack name=apgd,order=1,threshold=12 --gpu ${GPU} \
